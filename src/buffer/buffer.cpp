...
int32_t vkMapMemory(VkDevice device, VkDeviceMemory memory, int64_t offset, int64_t size, uint32_t flags, void** ppData) {
...
int32_t vkResetCommandBuffer(VkCommandBuffer commandBuffer, uint32_t flags) {
...
int32_t vkResetCommandPool(VkDevice device, VkCommandPool commandPool, uint32_t flags) {
